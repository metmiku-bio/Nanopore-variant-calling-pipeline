process CALL_VARIANTS_ITS {
    ...
    bcftools view -e 'REF="."' combined.genotyped.vcf -Oz -o tmp.vcf.gz

    bcftools sort tmp.vcf.gz -Oz -o tmp.sorted.vcf.gz

    bcftools norm -f ${ref} \
        -Oz \
        -o combined.genotyped.vcf.gz \
        tmp.sorted.vcf.gz
